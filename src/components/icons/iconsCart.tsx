...
import { BiSelectMultiple } from "@/assets/icons/bi/BiSelectMultiple"
...
const IconsCart = () => {
    const { multiSelect, setMultiSelect, cartIcons, cartTotal, addRemoveIcon, clearCart, createCommand } = useIconCart()
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            >
                ...
                {multiSelect && (
                    <span className="absolute -top-2 -right-2 bg-green-500 w-2.5 h-2.5 rounded-full" />
                )}
            </Button>
                    ...
                    <Dialog open={isOpen} onOpenChange={setIsOpen}>
                        <DialogContent className="max-w-3xl">
                            <DialogHeader className="space-y-1">
                                <DialogTitle className="text-xl font-semibold">Selected Icons</DialogTitle>
